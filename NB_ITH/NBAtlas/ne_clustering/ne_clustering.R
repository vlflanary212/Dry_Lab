...
results_dir <- here("NB_ITH", "NBAtlas", "ne_clustering")

# Load data
seurat_obj <- readRDS(here("NB_ITH", "NBAtlas", "data", "alldata", "01_filt_obj.rds"))

# Subset to only include the neuroendocrine cells
